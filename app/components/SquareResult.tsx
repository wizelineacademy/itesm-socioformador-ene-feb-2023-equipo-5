    ...
    <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
      <figure className="flex flex-col items-center justify-center p-8 text-center border-8 border-white rounded-t-lg bg-bluefigma1 md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700 ">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 ">
          <h3 className="text-4xl font-bold text-white dark:text-white">32%</h3>
        </blockquote>
      ...
      <figure className="flex flex-col items-center justify-center p-8 text-center bg-bluefigma4 border-8 border-white rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
          <h3 className="text-4xl font-bold text-white dark:text-white">56%</h3>
        </blockquote>
        <figcaption className="flex items-center justify-center space-x-3">
          <div className=" font-medium dark:text-white ">
      ...
      <figure className="flex flex-col items-center justify-center p-8 text-center bg-bluefigma2 border-8 border-white rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
          <h3 className="text-4xl font-bold text-white dark:text-white">92%</h3>
        </blockquote>
        <figcaption className="flex items-center justify-center space-x-3">
          <div className=" font-medium dark:text-white ">
      ...
      <figure className="flex flex-col items-center justify-center p-8 text-center bg-bluefigma6 border-8 border-white rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
          <h3 className="text-4xl font-bold text-white dark:text-white">69%</h3>
        </blockquote>
        <figcaption className="flex items-center justify-center space-x-3">
          <div className="font-medium dark:text-white ">
